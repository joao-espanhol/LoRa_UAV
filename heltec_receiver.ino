...
const char* ssid = "archweb";        // <<<<< nome da rede
const char* password = "pixo1234";    // <<<<< senha da rede
const char* server_ip = "10.29.42.201";       // <<<<< IP do seu computador (confirme qual é o IP do seu comp)
